...
const Banner = () => {
  return (
    <section id="banner" className="relative overflow-hidden bg-[#0F172B]">
      ...
      <div className="w-full py-36 md:py-44 lg:py-52 flex items-center justify-center min-h-screen relative z-10">
        <Container className="w-full max-w-[360px] md:max-w-[720px] lg:max-w-[1140px] mx-auto px-4">
          <div className="flex flex-col items-center justify-center text-center max-w-[950px] mx-auto">
            ...
            <h2 className="font-medium text-xl md:text-2xl lg:text-3xl text-slate-400 tracking-tight pb-3">
              Hi there, I'm
            </h2>
            ...
            <p className="text-[16px] lg:text-[19px] text-[#90A1B9] mt-6 pb-10 max-w-[700px] leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
              ...
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3 border border-slate-700 hover:border-[#FE9A00] text-slate-300 hover:text-white font-bold rounded-xl bg-slate-900/20 hover:bg-[#FE9A00]/5 transition-all duration-300 shadow-lg hover:shadow-[0_0_20px_rgba(254,154,0,0.1)] group"
              >
